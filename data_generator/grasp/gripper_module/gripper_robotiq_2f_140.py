...
class GripperRobotiq2F140(GripperBase):
    """
    Initialization of robotiq-2f-140 gripper
    """
    name = 'robotiq_2f_140'
    def __init__(self, world, gripper_size=1.):
        self.world = world
        self._gripper_size = gripper_size
        self.urdf_path = Path("/media/yons/6d379145-c1d8-430f-9056-7777219c83a8/MISCGrasp/data/assets/gripper/robotiq_2f_140/combined_mount_robotiq_2f_140.urdf")
        self.max_opening_width = 0.14 * self._gripper_size
        self.finger_depth = 0.143 * self._gripper_size
        self.finger_depth_init = 0.120 * self._gripper_size
        ...
        self._grasp_speed = 1
        self.inherent_link_len = 0.0331 * self._gripper_size
    ...
    def reset(self, T_world_tcp):
        ...
        self.joint1 = self.body.joints["finger_joint"]
        self.joint2 = self.body.joints["right_outer_knuckle_joint"]
    ...
    def read(self):
        ratio = ((self.joint1.get_position() - self.joint2.get_position() - 2 * self._driver_joint_lower) /
                 ((self._driver_joint_upper - self._driver_joint_lower) * 2))
...
if __name__ == '__main__':
    ...
    gripper = GripperRobotiq2F140(world)
    T_world_grasp = Transform(Rotation.from_euler('XYZ', [-np.pi, np.pi / 2, 0.]), [0., 0.07, 0.])
