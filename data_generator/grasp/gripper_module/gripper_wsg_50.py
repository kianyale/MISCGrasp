...
class GripperWSG50(GripperBase):
    """
    Initialization of WSG50 2 finger gripper
    """
    name = 'wsg_50'
    ...
    def __init__(self, world, gripper_size=1.):
        ...
        self.urdf_path = Path("/media/yons/6d379145-c1d8-430f-9056-7777219c83a8/MISCGrasp/data/assets/gripper/wsg_50/combined_mount_wsg_50.urdf")
        self.max_opening_width = 0.1 * self._gripper_size
        self.finger_depth = 0.08 * self._gripper_size
        self._finger_close_distance = 0.005 * self._gripper_size
        ...
        self.T_tcp_trlink = Transform(Rotation.from_matrix(np.array([[0., -1., 0.],
                                                                     [1., 0., 0.],
                                                                     [0., 0., 1.]])),
                                      np.array([0., 0., -0.075]) * self._gripper_size)
        ...
        self.inherent_link_len = 0.00539 * self._gripper_size
    ...
    def reset(self, T_world_tcp):
        ...
        self.world.add_constraint(
            self.body,
            self.body.links["finger_left"],
            self.body,
            self.body.links["finger_right"],
            pybullet.JOINT_GEAR,
            [1.0, 0.0, 0.0],
            Transform.identity(),
            Transform.identity(),
        ...
        self.joint1 = self.body.joints["base_joint_gripper_left"]
        self.joint2 = self.body.joints["base_joint_gripper_right"]
    ...
    def read(self):
        width = abs(self.joint1.get_position()) + self.joint2.get_position() - self.inherent_link_len
