...
class GripperRG2(GripperBase):
    """
    Initialization of RG2 2 finger gripper
    """
    name = 'rg2'
    def __init__(self, world, gripper_size=1.):
        ...
        self.urdf_path = Path("/media/yons/6d379145-c1d8-430f-9056-7777219c83a8/MISCGrasp/data/assets/gripper/rg2/combined_mount_rg2.urdf")
        self.max_opening_width = 0.0812 * self._gripper_size
        self.finger_depth = 0.085 * self._gripper_size
        self.finger_depth_init = 0.063 * self._gripper_size
        ...
        self.T_tcp_trlink = Transform(Rotation.from_matrix(np.array([[0., -1., 0.],
                                                                     [1., 0., 0.],
                                                                     [0., 0., 1.]])),
                                      np.array([0., 0., -0.078]) * self._gripper_size)
        ...
        self._grasp_force = 40
        self._grasp_speed = 1
        self.inherent_link_len = 0.0399 * self._gripper_size
    ...
    def reset(self, T_world_tcp):
        ...
        self.link1 = self.body.links["left_finger"]
        self.link2 = self.body.links["right_finger"]
