...
class GripperBarrettHand2F(GripperBase):
    ...
    """
    name = 'barrett_hand_2f'
    def __init__(self, world, gripper_size=1.):
        self.world = world
        self._gripper_size = gripper_size
        self.urdf_path = Path("/media/yons/6d379145-c1d8-430f-9056-7777219c83a8/MISCGrasp/data/assets/gripper/barrett_hand_2f/combined_mount_barrett_hand_2f"
                              ".urdf")
        ...
        self.max_opening_width = 0.14 * self._gripper_size
        self.finger_depth_init = 0.12 * self._gripper_size
        self.finger_depth = 0.093 * self._gripper_size
        ...
        self.T_tcp_trlink = Transform(Rotation.from_matrix(np.array([[0., -1., 0.],
                                                                     [1., 0., 0.],
                                                                     [0., 0., 1.]])),
                                      np.array([0., 0., -0.06]) * self._gripper_size)
    ...
    def read(self):
        ratio = ((self.joint1.get_position() + self.joint2.get_position() - 2 * self._joint_lower) /
                 ((self._joint_upper - self._joint_lower) * 2))
        return 1 - ratio
...
if __name__ == '__main__':
    ...
    gripper = GripperBarrettHand2F(world)
