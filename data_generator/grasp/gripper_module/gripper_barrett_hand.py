...
class GripperBarrettHand(GripperBase):
    ...
    """
    name = 'barrett_hand'
    def __init__(self, world, gripper_size=1., palm_joint=0.1, palm_joint_another=None):
        self.world = world
        self._gripper_size = gripper_size
        self.urdf_path = Path("/media/yons/6d379145-c1d8-430f-9056-7777219c83a8/MISCGrasp/data/assets/gripper/barrett_hand/combined_mount_barrett_hand"
                              ".urdf")
        ...
        self.finger_depth_init = 0.12 * self._gripper_size
        self.finger_depth = 0.112 * self._gripper_size
        self.T_body_tcp_first = Transform(Rotation.identity(), [0.0, 0.0, self.finger_depth_init]) * \
    ...
    def reset(self, T_world_tcp):
        ...
        self.joint1 = self.body.joints["bh_j12_joint"]
        self.joint2 = self.body.joints["bh_j22_joint"]
        self.joint3 = self.body.joints["bh_j32_joint"]

        self.traced_link = self.body.links["bh_base_link"]
    ...
    def move_tcp_xyz(self, target, eef_step=0.002, abort_on_contact=True, rotation_angle=0.):
        ...
        target_virtual = T_body_target * Transform(Rotation.identity(), [0., 0., self.finger_depth_init])
...
if __name__ == '__main__':
    ...
    gripper = GripperBarrettHand(world)
    ...
    T_world_grasp = Transform(Rotation.from_euler('XYZ', [-np.pi, 0., 0.]),
                              [0., 0., -0.008])#gripper.finger_depth_close])
    ...
    # T_world_trlink = gripper.body.links['bh_base_link'].get_pose()  # at this moment, world = tcp
    ...
    T_world_trlink = gripper.body.links['bh_base_link'].get_pose()
