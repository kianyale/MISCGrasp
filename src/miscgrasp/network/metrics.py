...
from src.miscgrasp.network.loss import Loss
from src.miscgrasp.utils.base_utils import color_map_backward
from src.miscgrasp.utils.draw_utils import concat_images_list
...
class VisualizeImage(Loss):
    ...
    def __call__(self, data_pr, data_gt, step, **kwargs):
        ...
        def get_img_depth(key):
            ...
            # depths = cv.applyColorMap(depths, cv.COLORMAP_JET)
            return depths
