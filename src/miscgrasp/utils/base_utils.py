...
def calc_rot_error_from_qxyzw_vgn(rotation_pred, rotations):
...
def calc_rot_error_from_qxyzw_ga(rotation_pred, rotations):
    pred_rmat = compute_rotation_matrix_from_quaternion_xyzw(rotation_pred)
    gt_rmat = compute_rotation_matrix_from_quaternion_xyzw(rotations)
    gt_R_error = compute_geodesic_distance_from_two_matrices(gt_rmat, pred_rmat)
    return gt_R_error
